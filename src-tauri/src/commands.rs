...
- {\"action\":\"settings\",\"op\":\"style\",\"style\":\"default|learning|friendly|buddy|kids|professional|scientific|adhd|ste100|govuk|plain|gdev|custom or empty\",\"length\":\"default|shorter|longer or empty\"} — set <STYLE_SCOPE> Empty keeps that half unchanged.\n\
