...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            okf::keep_notebooks_on_disk,
            okf::dismiss_keep_on_disk_offer,
            okf::icloud_container_offer,
            okf::dismiss_icloud_container_offer,
            okf::move_notebooks_to_icloud_container,
            okf::reveal_notebook_folder,
            okf::open_notebooks_folder_bundles,
            ...
            commands::growth_queries,
            commands::growth_feeds,
            commands::growth_links,
